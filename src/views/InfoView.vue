...
<template>
    <div class="min-h-screen -mb-6">
        ...
        <div class="text-center mx-16 mb-8">
            <h2 class="text-2xl font-bold text-primary-text mb-4">Version</h2>
            <p class="mb-4 font-bold">v. 1.0.0</p>
            <hr>
            <br>
            <h2 class="text-2xl font-bold text-primary-text mb-4">Über</h2>
            ...
            <h4 class="text-lg font-bold text-primary-text">Berliiiin!!</h4>
            ...
            <hr>
            <h2 class="text-2xl font-bold text-primary-text mb-4">Speicherung von Daten</h2>
            ...
            <hr>
            <h2 class="text-2xl font-bold text-primary-text mb-4">Credits</h2>
            <p>Conner Slipsager</p>
            <p>Daniel Omran</p>
            <p>Malte Eisermann</p>
            <p class="mb-4">Niklas Labitzke</p>
            <hr>
            <a href="https://github.com/GrafBunsen/halfway">
                <img class="mt-4 mx-auto" src="src\assets\github.svg" width="30px" alt="">
            </a>
        </div>
